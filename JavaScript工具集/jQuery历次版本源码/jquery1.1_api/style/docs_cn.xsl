...
<html>
<head>
	<title>jQuery Docs - <xsl:value-of select="/docs/@version"/> API 中文版</title>
	<link rel="stylesheet" href="style/style.css"/>
	<script src="dist/jquery.js"></script>
	<script src="js/tooltip.js"></script>
	<script src="js/pager.js"></script>
	<script src="js/doc_cn.js"></script>
</head>
<body>
	<h1>jQuery Docs - <xsl:value-of select="/docs/@version"/> API 中文版</h1>
	...
	<ul id="docs">
		<xsl:for-each select="method[not(@private)]">
			...
			<li>
				...
				<div class='more'>
					<div class="cn-en"><a href="#" class="cn-en">英文详解</a></div>
					<div class='desc'>
						
						<div class="cndesc">
						<xsl:for-each select="cndesc">
	...
	<p class="raw"><b>Raw Data:</b><xsl:text> </xsl:text><a href="http://www.ajax-master.com/Ajax/Jquery/api/data/jquery-docs-json.js">JSON</a>, <a href="http://www.ajax-master.com/Ajax/Jquery/api/data/jquery-docs-jsonp.js">JSONP</a>, <a href="http://www.ajax-master.com/Ajax/Jquery/api/data/jquery-docs-xml.xml">XML</a></p>
