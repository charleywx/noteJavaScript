...
FCKConfig.ToolbarSets["Basic"] = [
	['FitWindow','Bold','Italic','-','TextColor','-','Link','Unlink','Image','Flash','JustifyLeft','JustifyCenter','JustifyRight','FontSize','-','Source']
] ;
FCKConfig.ToolbarSets["easywolf"] = [
	['FitWindow','Bold','Italic','-','TextColor','-','Link','Unlink','JustifyLeft','JustifyCenter','JustifyRight','FontSize'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Find','Replace','-','RemoveFormat','-','TextColor','BGColor']
