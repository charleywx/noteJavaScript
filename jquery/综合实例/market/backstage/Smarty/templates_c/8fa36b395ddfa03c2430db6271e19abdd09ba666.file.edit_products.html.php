<?php /* Smarty version Smarty-3.1.16, created on 2014-03-09 09:36:14
         compiled from "F:\Web\apache\htdocs\market\backstage\Smarty\templates\edit_products.html" */ ?>
<?php /*%%SmartyHeaderCode:650531c35bb8dad12-90600042%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8fa36b395ddfa03c2430db6271e19abdd09ba666' => 
    array (
      0 => 'F:\\Web\\apache\\htdocs\\market\\backstage\\Smarty\\templates\\edit_products.html',
      1 => 1394357772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '650531c35bb8dad12-90600042',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_531c35bb978543_68581589',
  'variables' => 
  array (
    'bcjyzs' => 0,
    'edit' => 0,
...
<?php if ($_valid && !is_callable('content_531c35bb978543_68581589')) {function content_531c35bb978543_68581589($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div style="background-color: #fcfcfc">
    ...
    <DIV style="padding-left: 40px;">
        <DIV class="tadiv" style="padding-left: 0px;">
            ...
            <DIV style="LINE-HEIGHT: 25px; WIDTH: 22%; FLOAT: left; text-align:center; HEIGHT: 25px;;border:1px solid;border-left:none;">序列号</DIV>
...
?>
        <DIV>
            ...
            <DIV style="LINE-HEIGHT: 23px; WIDTH: 22%; FLOAT: left; text-align:center;HEIGHT: 23px;  border:1px solid;border-top:none;border-left:none;overflow: hidden;"><?php echo $_smarty_tpl->tpl_vars['bcjyzs']->value[$_smarty_tpl->getVariable('smarty')->value['section']['id']['index']]['item_no'];?>
</DIV>
...
" size="60"/><br/><br/>
                序列号：
                <input type="text" name="item_no" id="name" value="<?php echo $_smarty_tpl->tpl_vars['bcjyz']->value[0]['item_no'];?>
" size="60"/><br/><br/>
                重量：
                <input type="text" name="weight" id="name" value="<?php echo $_smarty_tpl->tpl_vars['bcjyz']->value[0]['weight'];?>
" size="60"/><br/><br/>
                发货方式：
                <input type="text" name="methods" id="name" value="<?php echo $_smarty_tpl->tpl_vars['bcjyz']->value[0]['methods'];?>
" size="60"/><br/><br/>
                产品描述：
